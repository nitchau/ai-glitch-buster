...
| 3 | Bots, rescue & gates | Bot entities + glitch art, drive-into-bot quiz modal, correct=fix+lift gate, wrong=explain+new Q, HUD (rescued X/5, timer) | in-progress | - | 2 | `.claude/PRPs/plans/bad-habit-harbor-phase-3.plan.md` |
