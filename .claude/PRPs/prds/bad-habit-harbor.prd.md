...
| 2 | Movement & controls | Top-down 4-dir movement, wall collision, on-screen D-pad + keyboard, water/wall rendering | complete | - | 1 | `.claude/PRPs/plans/completed/bad-habit-harbor-phase-2.plan.md` |
| 3 | Bots, rescue & gates | Bot entities + glitch art, drive-into-bot quiz modal, correct=fix+lift gate, wrong=explain+new Q, HUD (rescued X/5, timer) | complete | - | 2 | `.claude/PRPs/plans/completed/bad-habit-harbor-phase-3.plan.md` |
